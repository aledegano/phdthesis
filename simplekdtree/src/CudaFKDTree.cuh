...
public:
	...
	void search_in_the_box_linear(CudaFKDPoint*, unsigned int, unsigned int*, const unsigned int nStreams = 8, const unsigned int threads_per_block = 32) const;
	std::vector<std::vector<unsigned int> > search_in_the_box_sequential(CudaFKDPoint*) const;
