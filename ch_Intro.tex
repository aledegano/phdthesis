...
\section{HLT and computation challenges}
...
The Drell-Yan events are generated using \code{MadGraph} software then passed to \code{Pythia6} with \code{TuneZ2} for simulating parton showers, multiple interactions and fragmentation processes. Figure \ref{rechitsHisto} shows the distribution of the number of Rechits per event in the two simulations, normalized at 100.
\clearpage
