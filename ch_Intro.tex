...
The process is generated through \code{Pythia8} software and tuned with \code{tune4c}. Figure \ref{rechitsHisto} shows the distribution of the number of Rechits per event in the two simulations, normalized at 100.
\clearpage
